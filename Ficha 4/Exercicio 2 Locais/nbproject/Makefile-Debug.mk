...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/exercicio_2_locais.exe
...
${OBJECTDIR}/calculadora.o: calculadora.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/calculadora.o calculadora.c

${OBJECTDIR}/fp04_ex02_variaveis_locais.o: fp04_ex02_variaveis_locais.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fp04_ex02_variaveis_locais.o fp04_ex02_variaveis_locais.c
